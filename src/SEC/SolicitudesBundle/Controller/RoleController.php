...
use SEC\SolicitudesBundle\Entity\Role;
use SEC\SolicitudesBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SECSolicitudesBundle:Role')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SECSolicitudesBundle:Role')->find($id);
     ...
     * @Method("POST")
     * @Template("SECSolicitudesBundle:Role:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("SECSolicitudesBundle:Role:edit.html.twig")
     */
